...
1. **React Application**: The ReactJS Reminders app must be deployed to GitHub Pages at `https://jumperck.github.io/Reminders` (for production tests) or running locally at `http://localhost:3000` (for development)
...
2. **Automatic Testing**: Cypress tests run against the deployed application at `https://jumperck.github.io/Reminders`
